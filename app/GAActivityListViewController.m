...
#define kActivityListPath @"/Users/francis/activity.plist"

@interface GAActivityListViewController ()

@end

@implementation GAActivityListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString* path = [activity objectForKey:@"path"];
    NSString* destination = [activity objectForKey:@"destination"];
    BOOL success = [[activity objectForKey:@"status"] boolValue]; 
